...
def evaluate_train_network(key, model, device, data_loader, epoch):
    ...
    with torch.no_grad():
        ...
        write_log(key, "epoch:{}, loss: {}, other:{:.3f}|{:.3f}|{:.3f}, brandname:{:.3f}|{:.3f}|{:.3f}, quantity:{:.3f}|{:.3f}|{:.3f}, date:{:.3f}|{:.3f}|{:.3f}, usage:{:.3f}|{:.3f}|{:.3f}, diagnose:{:.3f}|{:.3f}|{:.3f}, generic:{:.3f}|{:.3f}|{:.3f}".format(epoch, epoch_test_loss, *results))        
...
def evaluate_test_network(key, model, device, data_loader, epoch):
    ...
    with torch.no_grad():
        ...
        write_log(key, "epoch:{}, test loss: {}, brandname:{:.3f}, quantity:{:.3f}, date:{:.3f}, usage:{:.3f}, diagnose:{:.3f}, generic:{:.3f}, mean:{:.3f}".format(epoch, epoch_test_loss, *acc_right))        
        # print("========================", acc_right, "=======================================")
...
def main():
    ...
    parser.add_argument('--batch_size', default=4, help="Please give a value for batch_size")
    parser.add_argument('--train_dataset', default='./train', help="Please give a value for dataset name")
    parser.add_argument('--test_dataset', default='./test', help="Please give a value for dataset name")
    parser.add_argument('--split', default='\t', help="Please give a value for dataset name")
    parser.add_argument('--labels', default=['other', 'brandname', 'quantity', 'date', 'usage', 'diagnose', 'generic'], help="Please give a value for dataset name")
    ...
    parser.add_argument('--epochs', default=50, help="Please give a value for epochs")
